...
import { AccountType, Period, Currency, type PeriodParams } from '@/types';
...
export function increasePeriod(type: Period, period: PeriodParams, value: number): PeriodParams {
    if (value === 0) {
        return period;
    }
    let diff, year, month;
